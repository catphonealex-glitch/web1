...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "DubStage — Fan Dubbing Forum" },
      { name: "description", content: "Cast, collaborate, and create fan dubs. Post projects, audition with voice demos, and join the global fan-dubbing community." },
      { property: "og:title", content: "DubStage — Fan Dubbing Forum" },
      { property: "og:description", content: "Cast, collaborate, and create fan dubs." },
