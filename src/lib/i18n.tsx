...
const en: Dict = {
  ...
  "about.lead": "DubStage is a community for amateur dubbing — a place where aspiring voice actors take their first steps toward a career behind the mic.",
...
const lv: Dict = {
  ...
  "home.match.fuzzy": "Nav precīzes sakritības — rāda tuvākos rezultātus",
